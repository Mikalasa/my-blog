...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/Mikalasa',     // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
  ...
  name: 'Xingyi',
  bio: 'Sharing insights, experiences from a journey in front-end and full-stack development, along with more topics.',
  links: [
    {
      name: 'Twitter',
